...
- **Bash shortcuts do not work**  <strike>Bash shortcuts like tab autocomplete, previous/next command navigation using up/down arrow key etc does not work</strike>. The data is sent to the server only on 'enter' press & the response is populated in the output area.
